...
export const WORKFLOWS: WorkflowMeta[] = [
...

  {
    ...
    metaDescription: "Free call sheets, shot lists, model + location releases, equipment rental agreements, and drone logs. Every document you need for a production shoot day.",
    ...
    icp: "both",
    steps: [
      { tool: "call-sheet", heading: "1. Build + send the call sheet", body: "Crew, call times, location, parking, weather, sunrise/sunset, nearest hospital, emergency contact, schedule. Send 24h before. Not optional." },
      { tool: "shot-list", heading: "2. Write the shot list", body: "Scene-by-scene breakdown with type (wide / med / CU) and lens notes. Print one, clip to the slate, check shots off as you go." },
      { tool: "model-release", heading: "3. Get releases signed — adults", body: "Anyone on camera who isn't crew signs before cameras roll. Without it you can't use the footage commercially." },
      { tool: "minor-release", heading: "4. Minors need parental sign-off", body: "A regular model release isn't enough for anyone under 18. Parent or guardian signs, on site, before the shoot." },
      { tool: "location-release", heading: "5. Shooting on private property", body: "If you're not at a studio or rental, the property owner signs a location release. Covers you for claims + damage expectations." },
      { tool: "equipment-rental", heading: "6. Renting gear?", body: "If you're renting gear to or from another crew, the rental agreement covers replacement value + insurance requirements." },
      { tool: "drone-log", heading: "7. Flying a drone (Part 107)", body: "Every Part 107 flight has to be logged for FAA + tax records. Do it on the day — details slip otherwise." },
    ],
    closer:
...

  {
    ...
    steps: [
      ...
      { tool: "expenses", heading: "8. Tax-prep: sort a year of expenses in 10 minutes", body: "Export your business account CSV, drop it in, let keyword rules bucket everything into Schedule C categories. Your CPA will thank you." },
    ],
    closer:
...

  {
    id: "closing-out",
    slug: "closing-out",
    title: "Closing out a project: wrap, testimonial, usage rights",
    pageTitle: "How to close out a video production project — wrap report, testimonial, usage license",
    metaDescription: "Free templates for the final steps of every project: wrap report, testimonial request, and usage license.",
    tagline: "Don't leave the compound interest on the table.",
    intro:
      "The work's done, the client's happy, the money's in. Most production companies move on. The pros use this moment to send a clean wrap, ask for a testimonial, and lock down usage rights. Here's how.",
    icp: "production",
    steps: [
      ...
      { tool: "usage-license", heading: "3. Clarify usage rights if you didn't upfront", body: "If your original contract didn't specify granular rights, send a usage license that defines what the client can use the footage for and for how long. Any use beyond that scope = additional license fee." },
    ],
    closer:
      "Three steps turn every project from a transaction into an asset. Your portfolio grows. Your testimonials compound. Your rights stay yours. Slate auto-prompts you through this flow when each invoice is marked paid.",
  },

  {
    ...
    pageTitle: "Free video production legal templates — contracts, releases, licenses",
    metaDescription: "Free legal templates for production companies: client contract, independent contractor agreement, model + location releases, usage license.",
